...
public class DemoController {
  ...
  @Autowired
  DemoController(@Qualifier("swimObj") Coach swimCoach, @Qualifier("cricketCoach") Coach cricketCoachObj,@Qualifier("footballCoach") Coach footballCoachObj,
  ...
  @GetMapping("/dailyWorkoutSwimming")
  public String getSwimwWorkout() { return this.swimCoach.getDailyWorkout(); }
}
